...
% Redefine SAGE-specific commands for ctex
\newcommand{\runninghead}[1]{}
\newcommand{\corrauth}[1]{}
\newcommand{\email}[1]{}
\newcommand{\affilnum}[1]{}
\newenvironment{acks}{\section*{Acknowledgements}}{}
\newenvironment{funding}{\section*{Funding}}{}
\newenvironment{dci}{\section*{Declaration of Conflicting Interests}}{}
\newcommand{\keywords}[1]{\par\noindent\textbf{Keywords:} #1\par\vspace{0.3cm}}
...
\author{Xing Shujun$^{1}$, Liu Peng$^{1}$,\\
An Zhengguang$^{1}$, Wang Suomin$^{1}$,\\
and Wei Qinjiang$^{1}$\\[0.3cm]
$^{1}$Heze Vocational College, Shandong, China\\[0.3cm]
Corresponding author: Xing Shujun, xsj@bupt.edu.cn}
...
B (Control 2) & 46 & 50.0 & 67.9 $\pm$ 13.1 & Ebbinghaus vocab device$^*$ \\
C (Experimental) & 47 & 51.1 & 68.1 $\pm$ 12.8 & AI five-step sentence method \\
\bottomrule
\end{tabular}

\vspace{2pt}\small $^*$中国市场大量存在的传统学习机，基于艾宾浩斯遗忘曲线提供词汇和句子机械记忆功能，无AI句子评价或AIGC视频功能。
\end{table}
